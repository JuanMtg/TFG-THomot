...
\begin{abstract}
In this paper we study the basic tools in Homotopy Theory. First, we briefly introduce basic concepts in homotopy theory to then define the suspension $\Sigma X$ of a space and the loop space $\Omega X$. To follow up, fibrations and cofibrations are introduced along with some examples about them. Finally, we study higher order homotopy groups and stablish a connection between them and the concepts previously defined.
\end{abstract}
